      ...
      <div class="holder-top-desktop d-none d-md-block">
        <div class="row">
          <div class="col-auto">
            <div class="h-info01">
              <div class="tt-item">
                <address>Shop 15 Onitsha Mall, Onitsha,  Anambra State, Nigeria</address>
              </div>
              <div class="tt-item">Mon-Fri 08:00 AM - 07:00 PM</div>
              <div class="tt-item">
                <a href="mailto:info@santizex-site.com">info@beautifulcolorslaundry.com.ng</a>
              </div>
            </div>
          </div>
          <div class="col-auto ml-auto">
                ...
                <div class="tt-item">
                  <address>
                    <a href="tel:1(800)765-43-21"
                      ><span class="icons-483947"></span> 07033867462, 09063436744</a
                    >
                  </address>
                </div>
              </div>
            ...
            <div class="tt-obj">
              <ul class="h-social">
                ...
                <li>
                  <a
                    href="https://web.facebook.com/BEAUTIFULcolours247"
                    target="https://web.facebook.com/BEAUTIFULcolours247"
                    class="icons-2111532"
                  ></a>
                </li>
                <li>
